...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3041"><img src="assets/ledger-light.svg?v=3041" width="100%" alt="ROFL ledger, height 3041"></picture>

| | |
|---|---|
| **height** | `3041` |
| **tip** | `4de10aaf11ad6f9323ba3f57d7eea4fe8c25ee3bfb762657dc7d9cba7e736816` |
| **difficulty** | `93.6`  (bits `0x1d2bc43a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,509,999,283,796` expected hashes |
| **supply** | `20999.02953720 ROFL` in `3042` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1233` | `40.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.51622301 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3041. Verify it yourself: <code>python3 verify.py</code></sub>
