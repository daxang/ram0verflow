...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3023"><img src="assets/ledger-light.svg?v=3023" width="100%" alt="ROFL ledger, height 3023"></picture>

| | |
|---|---|
| **height** | `3023` |
| **tip** | `4c1e7c447fceea308f1a4951ecbe69163403fa38c555e860c6ad4816e1f4a93f` |
| **difficulty** | `141.4`  (bits `0x1d1cf838`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,507,823,497,540` expected hashes |
| **supply** | `20998.97460570 ROFL` in `3024` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3023` | `4c1e7c447fceea308f1a…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00305175` | 2026-09-19 12:22 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1216` | `40.2%` |
...
| [@ram0verflow](https://github.com/ram0verflow) | `65` | `2.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.46434326 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3023. Verify it yourself: <code>python3 verify.py</code></sub>
