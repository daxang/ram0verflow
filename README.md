...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3499"><img src="assets/ledger-light.svg?v=3499" width="100%" alt="ROFL ledger, height 3499"></picture>

| | |
|---|---|
| **height** | `3499` |
| **tip** | `b334df0bada414a75d35e4538f2ca48c144029326298eeeb16cb2c36eb2a74cd` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,556,272,824` expected hashes |
| **supply** | `20999.78636910 ROFL` in `3500` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1452` | `41.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.88929848 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3499. Verify it yourself: <code>python3 verify.py</code></sub>
