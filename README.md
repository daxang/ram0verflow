...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3117"><img src="assets/ledger-light.svg?v=3117" width="100%" alt="ROFL ledger, height 3117"></picture>

| | |
|---|---|
| **height** | `3117` |
| **tip** | `bf42d625bef739954251bedb9f71ad229508283291538becb40cae9b3a933e29` |
| **difficulty** | `48.8`  (bits `0x1d53f385`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,515,089,977,846` expected hashes |
| **supply** | `20999.26147020 ROFL` in `3118` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3117. Verify it yourself: <code>python3 verify.py</code></sub>
