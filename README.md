...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3142"><img src="assets/ledger-light.svg?v=3142" width="100%" alt="ROFL ledger, height 3142"></picture>

| | |
|---|---|
| **height** | `3142` |
| **tip** | `ee7d2e9f12f51eb81c4c9201e6be3cd6d485b5f14391f7341a308ce15e852bf9` |
| **difficulty** | `41.8`  (bits `0x1d6216a0`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,516,189,394,640` expected hashes |
| **supply** | `20999.33776395 ROFL` in `3143` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3142. Verify it yourself: <code>python3 verify.py</code></sub>
