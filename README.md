...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3030"><img src="assets/ledger-light.svg?v=3030" width="100%" alt="ROFL ledger, height 3030"></picture>

| | |
|---|---|
| **height** | `3030` |
| **tip** | `db18457e1a17a971cb9b29e338fea1ef98f3c933839630bbbb257602d1bd3bfd` |
| **difficulty** | `118.0`  (bits `0x1d22b71a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,508,689,537,085` expected hashes |
| **supply** | `20998.99596795 ROFL` in `3031` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1223` | `40.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.48570551 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3030. Verify it yourself: <code>python3 verify.py</code></sub>
