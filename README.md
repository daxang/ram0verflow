...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3055"><img src="assets/ledger-light.svg?v=3055" width="100%" alt="ROFL ledger, height 3055"></picture>

| | |
|---|---|
| **height** | `3055` |
| **tip** | `e62c9f974a0a14067e865763d0cfbb6288f6b232052afa021f37a17ace38a0a6` |
| **difficulty** | `93.6`  (bits `0x1d2bc43a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,511,373,154,868` expected hashes |
| **supply** | `20999.07226170 ROFL` in `3056` unspent outputs |
...
| `3046` | `c3b0b182d5bbc5f36d6c…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.00305175` | 2026-09-19 17:17 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1246` | `40.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.55589576 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3055. Verify it yourself: <code>python3 verify.py</code></sub>
