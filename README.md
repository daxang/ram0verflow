...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3497"><img src="assets/ledger-light.svg?v=3497" width="100%" alt="ROFL ledger, height 3497"></picture>

| | |
|---|---|
| **height** | `3497` |
| **tip** | `8540bba78d3be9d820195322f9ded6aef9919caed981a08b1731ad08f4fba1c6` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,554,175,674` expected hashes |
| **supply** | `20999.78484324 ROFL` in `3498` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3497` | `8540bba78d3be9d82019…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.00076293` | 2026-09-23 21:12 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1450` | `41.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.88777262 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3497. Verify it yourself: <code>python3 verify.py</code></sub>
