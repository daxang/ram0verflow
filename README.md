...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3097"><img src="assets/ledger-light.svg?v=3097" width="100%" alt="ROFL ledger, height 3097"></picture>

| | |
|---|---|
| **height** | `3097` |
| **tip** | `8b4ca2e63053d82bffffa89310247761317e84484d5f9d37fc381f322775c8ac` |
| **difficulty** | `47.7`  (bits `0x1d55c878`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,514,073,327,680` expected hashes |
| **supply** | `20999.20043520 ROFL` in `3098` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3097` | `8b4ca2e63053d82bffff…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00305175` | 2026-09-20 03:23 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1277` | `41.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.65050001 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3097. Verify it yourself: <code>python3 verify.py</code></sub>
