...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3345"><img src="assets/ledger-light.svg?v=3345" width="100%" alt="ROFL ledger, height 3345"></picture>

| | |
|---|---|
| **height** | `3345` |
| **tip** | `fece7e218596553da1aa801ca80e93de2e9b405ca85757b08ced7df9af844bb1` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,394,792,274` expected hashes |
| **supply** | `20999.65819672 ROFL` in `3346` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1370` | `40.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.81987176 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3345. Verify it yourself: <code>python3 verify.py</code></sub>
