...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3466"><img src="assets/ledger-light.svg?v=3466" width="100%" alt="ROFL ledger, height 3466"></picture>

| | |
|---|---|
| **height** | `3466` |
| **tip** | `5aeb915f890f73ab37f9b676f07535c885935d8c362aa63f5f159e215bb80bfb` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,521,669,849` expected hashes |
| **supply** | `20999.76119241 ROFL` in `3467` unspent outputs |
...
| `3458` | `140b1440779ff9713c27…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00076293` | 2026-09-23 13:12 UTC |
| `3457` | `193a709622ba44075336…` | [@hbzhong](https://github.com/hbzhong) | `运气来串门，别给它发员工证。` | `1` | `0.00076293` | 2026-09-23 13:00 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1431` | `41.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.87327695 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3466. Verify it yourself: <code>python3 verify.py</code></sub>
