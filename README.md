...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3377"><img src="assets/ledger-light.svg?v=3377" width="100%" alt="ROFL ledger, height 3377"></picture>

| | |
|---|---|
| **height** | `3377` |
| **tip** | `da30154c217b4313b0cb0f235b4f812e50263f9d1734777a2b5dfd8d5eee3432` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,428,346,674` expected hashes |
| **supply** | `20999.69329164 ROFL` in `3378` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.83970803 ROFL` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.42156850 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3377. Verify it yourself: <code>python3 verify.py</code></sub>
