...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3252"><img src="assets/ledger-light.svg?v=3252" width="100%" alt="ROFL ledger, height 3252"></picture>

| | |
|---|---|
| **height** | `3252` |
| **tip** | `6bafc37ead47b745cfa5fbad93827ebbba2488e35b28ffe60e5cd4e8eeaebadb` |
| **difficulty** | `19.1`  (bits `0x1e00d665`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,519,772,666,591` expected hashes |
| **supply** | `20999.51629081 ROFL` in `3253` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `207` | `6.4%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.35290440 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3252. Verify it yourself: <code>python3 verify.py</code></sub>
