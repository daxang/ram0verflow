...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3047"><img src="assets/ledger-light.svg?v=3047" width="100%" alt="ROFL ledger, height 3047"></picture>

| | |
|---|---|
| **height** | `3047` |
| **tip** | `731caa97d3d60e89fef743b44a0d61f50e2116367e610ca165c8228563914370` |
| **difficulty** | `93.6`  (bits `0x1d2bc43a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,510,588,085,684` expected hashes |
| **supply** | `20999.04784770 ROFL` in `3048` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1239` | `40.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.53453351 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3047. Verify it yourself: <code>python3 verify.py</code></sub>
