...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3048"><img src="assets/ledger-light.svg?v=3048" width="100%" alt="ROFL ledger, height 3048"></picture>

| | |
|---|---|
| **height** | `3048` |
| **tip** | `eced5bc08d6beee4f60b2b1d50e9d0e3006852446f9768cfc0e464011163ed6d` |
| **difficulty** | `93.6`  (bits `0x1d2bc43a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,510,686,219,332` expected hashes |
| **supply** | `20999.05089945 ROFL` in `3049` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1240` | `40.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.53758526 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3048. Verify it yourself: <code>python3 verify.py</code></sub>
