...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3031"><img src="assets/ledger-light.svg?v=3031" width="100%" alt="ROFL ledger, height 3031"></picture>

| | |
|---|---|
| **height** | `3031` |
| **tip** | `b0b8ee884fc509a3bc9b14f7459863798c284acc795063475f2b62e41697dcf8` |
| **difficulty** | `118.0`  (bits `0x1d22b71a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,508,813,257,020` expected hashes |
| **supply** | `20998.99901970 ROFL` in `3032` unspent outputs |
...
| `3030` | `db18457e1a17a971cb9b…` | [@ywltby](https://github.com/ywltby) | `面善打个D啊，喜欢我的战斗脸吗？` | `1` | `0.00305175` | 2026-09-19 13:54 UTC |
| `3029` | `179fd82cf6e614139a44…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.00305175` | 2026-09-19 13:40 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1224` | `40.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.48875726 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3031. Verify it yourself: <code>python3 verify.py</code></sub>
