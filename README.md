...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3058"><img src="assets/ledger-light.svg?v=3058" width="100%" alt="ROFL ledger, height 3058"></picture>

| | |
|---|---|
| **height** | `3058` |
| **tip** | `a555b7c7b080ec6d1829335c710f842cf0d58c3211896df4ff2d755815841ff6` |
| **difficulty** | `73.8`  (bits `0x1d377e06`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,511,605,347,563` expected hashes |
| **supply** | `20999.08141695 ROFL` in `3059` unspent outputs |
...
| `3049` | `6a1c5d5ba083c351a8f1…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.00305175` | 2026-09-19 17:58 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1249` | `40.8%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `16.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.56505101 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3058. Verify it yourself: <code>python3 verify.py</code></sub>
