...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3276"><img src="assets/ledger-light.svg?v=3276" width="100%" alt="ROFL ledger, height 3276"></picture>

| | |
|---|---|
| **height** | `3276` |
| **tip** | `75dbae21a7fc169d825a3f814325409101709c79171d37ebf91b6cc419a551f3` |
| **difficulty** | `15.4`  (bits `0x1e010972`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,203,372,710` expected hashes |
| **supply** | `20999.55291169 ROFL` in `3277` unspent outputs |
...
| `3270` | `6746a38531102b866839…` | [@Aitensa](https://github.com/Aitensa) | `gm from Aitensa` | `1` | `0.00152587` | 2026-09-21 11:44 UTC |
| `3269` | `b78a337df0eeec6e30fb…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.00152587` | 2026-09-21 11:41 UTC |
| `3268` | `9375701111175e650b17…` | [@Aitensa](https://github.com/Aitensa) | `gm from Aitensa` | `1` | `0.00152587` | 2026-09-21 11:34 UTC |
| `3267` | `7d2904f5ab4fae9c3f5d…` | [@Aitensa](https://github.com/Aitensa) | `gm from Aitensa` | `1` | `0.00152587` | 2026-09-21 11:21 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1351` | `41.2%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `14.9%` |
| [@americanvain](https://github.com/americanvain) | `315` | `9.6%` |
| [@hbzhong](https://github.com/hbzhong) | `212` | `6.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.79088023 ROFL` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.36053375 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3276. Verify it yourself: <code>python3 verify.py</code></sub>
