...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3029"><img src="assets/ledger-light.svg?v=3029" width="100%" alt="ROFL ledger, height 3029"></picture>

| | |
|---|---|
| **height** | `3029` |
| **tip** | `179fd82cf6e614139a443316ccf226ca17bacb135b7a4f95bfeb81220ce4fb08` |
| **difficulty** | `118.0`  (bits `0x1d22b71a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,508,565,817,150` expected hashes |
| **supply** | `20998.99291620 ROFL` in `3030` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1222` | `40.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.48265376 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3029. Verify it yourself: <code>python3 verify.py</code></sub>
