...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3043"><img src="assets/ledger-light.svg?v=3043" width="100%" alt="ROFL ledger, height 3043"></picture>

| | |
|---|---|
| **height** | `3043` |
| **tip** | `eac8f427ab722872bf04dabb71f8d8009d5112b8a00dee688a5459e81aa6feb5` |
| **difficulty** | `93.6`  (bits `0x1d2bc43a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,510,195,551,092` expected hashes |
| **supply** | `20999.03564070 ROFL` in `3044` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1235` | `40.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.52232651 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3043. Verify it yourself: <code>python3 verify.py</code></sub>
