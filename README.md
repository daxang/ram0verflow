...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3036"><img src="assets/ledger-light.svg?v=3036" width="100%" alt="ROFL ledger, height 3036"></picture>

| | |
|---|---|
| **height** | `3036` |
| **tip** | `b76d2c071f4d259e6200625de35d63c8c7effa68d517840f728e22f03318287d` |
| **difficulty** | `118.0`  (bits `0x1d22b71a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,509,431,856,695` expected hashes |
| **supply** | `20999.01427845 ROFL` in `3037` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1228` | `40.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.50096426 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3036. Verify it yourself: <code>python3 verify.py</code></sub>
