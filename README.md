...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3471"><img src="assets/ledger-light.svg?v=3471" width="100%" alt="ROFL ledger, height 3471"></picture>

| | |
|---|---|
| **height** | `3471` |
| **tip** | `e908f9aa25d5395b75ac7ae734a3068a217739de7a99eebbd7b561179118937b` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,526,912,724` expected hashes |
| **supply** | `20999.76500706 ROFL` in `3472` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1436` | `41.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.87709160 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3471. Verify it yourself: <code>python3 verify.py</code></sub>
