...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3069"><img src="assets/ledger-light.svg?v=3069" width="100%" alt="ROFL ledger, height 3069"></picture>

| | |
|---|---|
| **height** | `3069` |
| **tip** | `061493bf9b31a270dd0ff505c289e77ef00f12aff832b18a9f23dcf418b50d3f` |
| **difficulty** | `73.8`  (bits `0x1d377e06`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,512,456,720,778` expected hashes |
| **supply** | `20999.11498620 ROFL` in `3070` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3069` | `061493bf9b31a270dd0f…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00305175` | 2026-09-19 22:11 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1258` | `41.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.59251676 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3069. Verify it yourself: <code>python3 verify.py</code></sub>
