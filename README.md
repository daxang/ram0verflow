...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3514"><img src="assets/ledger-light.svg?v=3514" width="100%" alt="ROFL ledger, height 3514"></picture>

| | |
|---|---|
| **height** | `3514` |
| **tip** | `46c4c74b911788e0ad3ab0d26d0fdcaa2773a1baa6e9a935dbd1dd157ed0b93c` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,572,001,449` expected hashes |
| **supply** | `20999.79781305 ROFL` in `3515` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3514` | `46c4c74b911788e0ad3a…` | [@ywltby](https://github.com/ywltby) | `T1我们明天就把你送回家。` | `1` | `0.00076293` | 2026-09-24 00:47 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1458` | `41.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.89387606 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3514. Verify it yourself: <code>python3 verify.py</code></sub>
