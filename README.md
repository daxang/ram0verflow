...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3319"><img src="assets/ledger-light.svg?v=3319" width="100%" alt="ROFL ledger, height 3319"></picture>

| | |
|---|---|
| **height** | `3319` |
| **tip** | `c5b02f2b187c9c38dfa1a0b83ed4157e1fa0cd92cfbe96a320a8f5d24361680c` |
| **difficulty** | `1.2`  (bits `0x1e0cf783`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,365,185,228` expected hashes |
| **supply** | `20999.61852410 ROFL` in `3320` unspent outputs |
...
| `3317` | `ee294f013feb5408330f…` | [@hbzhong](https://github.com/hbzhong) | `不必赚每一分钱，还得留时间花。` | `1` | `0.00152587` | 2026-09-22 07:54 UTC |
| `3316` | `7f42a52e30cb1490c865…` | [@hbzhong](https://github.com/hbzhong) | `机会天天有，脑子只有一个。` | `1` | `0.00152587` | 2026-09-22 07:39 UTC |
...
| [@hbzhong](https://github.com/hbzhong) | `227` | `6.8%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.38342180 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3319. Verify it yourself: <code>python3 verify.py</code></sub>
