...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3512"><img src="assets/ledger-light.svg?v=3512" width="100%" alt="ROFL ledger, height 3512"></picture>

| | |
|---|---|
| **height** | `3512` |
| **tip** | `026c5d4e4a0694dd30d37d6d08906ac07dc615aa882e0c82c7fe0a0df33ea34d` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,569,904,299` expected hashes |
| **supply** | `20999.79628719 ROFL` in `3513` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1456` | `41.4%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3512. Verify it yourself: <code>python3 verify.py</code></sub>
