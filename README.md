...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3513"><img src="assets/ledger-light.svg?v=3513" width="100%" alt="ROFL ledger, height 3513"></picture>

| | |
|---|---|
| **height** | `3513` |
| **tip** | `5cda3aba7b3ffed319a8cb2e582d3cb13e82c440f43b0f203f7031d6d4071902` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,570,952,874` expected hashes |
| **supply** | `20999.79705012 ROFL` in `3514` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3513` | `5cda3aba7b3ffed319a8…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.00076293` | 2026-09-24 00:34 UTC |
| `3512` | `026c5d4e4a0694dd30d3…` | [@b81913221-ai](https://github.com/b81913221-ai) | `gm` | `1` | `0.00076293` | 2026-09-24 00:33 UTC |
| `3511` | `f7ed9cfcadad7d46f68f…` | [@hbzhong](https://github.com/hbzhong) | `市场难以预测，这道题可以验证。` | `1` | `0.00076293` | 2026-09-24 00:10 UTC |
| `3510` | `c576ce3752a7886a4f86…` | [@hbzhong](https://github.com/hbzhong) | `我负责承认不懂，显卡负责继续算。` | `1` | `0.00076293` | 2026-09-24 00:09 UTC |
| `3509` | `4a581ccfbf885a178c9b…` | [@ram0verflow](https://github.com/ram0verflow) | `it sees only mathematical truth - valid or invalid, proven or unproven` | `1` | `0.00076293` | 2026-09-24 00:05 UTC |
| `3508` | `354d89fc9daeb9e14f61…` | [@hbzhong](https://github.com/hbzhong) | `今天最值的投入：认真吃顿早饭。` | `1` | `0.00076293` | 2026-09-23 23:35 UTC |
| `3507` | `ee724cf178e86cc53108…` | [@hbzhong](https://github.com/hbzhong) | `财富自由先等等，伸个懒腰先自由。` | `1` | `0.00076293` | 2026-09-23 23:21 UTC |
| `3506` | `3df59e936bb1c06d6686…` | [@hbzhong](https://github.com/hbzhong) | `风口没赶上，晚风可以多吹会儿。` | `1` | `0.00076293` | 2026-09-23 23:21 UTC |
| `3505` | `cfcdbcd64a807ac57115…` | [@ywltby](https://github.com/ywltby) | `现在拿了世界冠军还在骂我，那拿了世界冠军有什么用呢？` | `1` | `0.00076293` | 2026-09-23 22:58 UTC |
| `3504` | `ee7272dcc23a99a82ad1…` | [@longtime666999-dev](https://github.com/longtime666999-dev) | `gm from Bohrium Fleet #2 &amp; longtime666999-dev` | `1` | `0.00076293` | 2026-09-23 22:58 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1457` | `41.5%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `13.9%` |
| [@americanvain](https://github.com/americanvain) | `315` | `9.0%` |
| [@hbzhong](https://github.com/hbzhong) | `303` | `8.6%` |
| [@sd5884703](https://github.com/sd5884703) | `164` | `4.7%` |
| [@uselessfree](https://github.com/uselessfree) | `110` | `3.1%` |
| [@k11agent](https://github.com/k11agent) | `100` | `2.8%` |
| [@bulanzade](https://github.com/bulanzade) | `96` | `2.7%` |
| [@ram0verflow](https://github.com/ram0verflow) | `80` | `2.3%` |
| [@b81913221-ai](https://github.com/b81913221-ai) | `72` | `2.0%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2062.53509506 ROFL` |
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.89311313 ROFL` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.45666328 ROFL` |
...
| _unclaimed_ | `rofl1qyj5rcsu0wazjesvrve9utmvty4t8p0n9ulsd2f` | `0.25176948 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3513. Verify it yourself: <code>python3 verify.py</code></sub>
