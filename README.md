...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3346"><img src="assets/ledger-light.svg?v=3346" width="100%" alt="ROFL ledger, height 3346"></picture>

| | |
|---|---|
| **height** | `3346` |
| **tip** | `0436b2f3b9e595a48f30b148374ddf985c6a4fa6ebd0dadc4799ca86b35c04fd` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,395,840,849` expected hashes |
| **supply** | `20999.65972259 ROFL` in `3347` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1371` | `41.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.82139763 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3346. Verify it yourself: <code>python3 verify.py</code></sub>
