...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3318"><img src="assets/ledger-light.svg?v=3318" width="100%" alt="ROFL ledger, height 3318"></picture>

| | |
|---|---|
| **height** | `3318` |
| **tip** | `2aec8b098dd9ce019684a24785bb02a129973e7deb97eb558606dc407f0d9738` |
| **difficulty** | `1.2`  (bits `0x1e0cf783`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,363,891,373` expected hashes |
| **supply** | `20999.61699823 ROFL` in `3319` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `226` | `6.8%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.38189593 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3318. Verify it yourself: <code>python3 verify.py</code></sub>
