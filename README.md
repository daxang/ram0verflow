...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3461"><img src="assets/ledger-light.svg?v=3461" width="100%" alt="ROFL ledger, height 3461"></picture>

| | |
|---|---|
| **height** | `3461` |
| **tip** | `717abfa13a715307b41af7df5d06e70c38b2f991f22b7d367b0717313d27319e` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,516,426,974` expected hashes |
| **supply** | `20999.75737776 ROFL` in `3462` unspent outputs |
...
| `3452` | `773109936eb182b763e3…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00076293` | 2026-09-23 11:55 UTC |
...
| [@hbzhong](https://github.com/hbzhong) | `285` | `8.2%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.44293054 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3461. Verify it yourself: <code>python3 verify.py</code></sub>
