...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3072"><img src="assets/ledger-light.svg?v=3072" width="100%" alt="ROFL ledger, height 3072"></picture>

| | |
|---|---|
| **height** | `3072` |
| **tip** | `58e543a9e1b3b732599ffc103a40c5b8e53bb348edf9b9a7d4caa260455f5d05` |
| **difficulty** | `57.3`  (bits `0x1d477f92`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,512,671,586,790` expected hashes |
| **supply** | `20999.12414145 ROFL` in `3073` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1261` | `41.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.60167201 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3072. Verify it yourself: <code>python3 verify.py</code></sub>
