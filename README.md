...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3418"><img src="assets/ledger-light.svg?v=3418" width="100%" alt="ROFL ledger, height 3418"></picture>

| | |
|---|---|
| **height** | `3418` |
| **tip** | `ba34a39de93fafc75d939956031c11dc7fa825e1cec3d31a1bedae6a7bbfefbd` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,471,338,249` expected hashes |
| **supply** | `20999.72457177 ROFL` in `3419` unspent outputs |
...
| [@b81913221-ai](https://github.com/b81913221-ai) | `67` | `2.0%` |
...
| _unclaimed_ | `rofl1qyj5rcsu0wazjesvrve9utmvty4t8p0n9ulsd2f` | `0.24795483 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3418. Verify it yourself: <code>python3 verify.py</code></sub>
