...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3498"><img src="assets/ledger-light.svg?v=3498" width="100%" alt="ROFL ledger, height 3498"></picture>

| | |
|---|---|
| **height** | `3498` |
| **tip** | `bf11b4839e6a383c3d568cbf82fc583806bc7af4922ccbd5c107cf1e192953bb` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,555,224,249` expected hashes |
| **supply** | `20999.78560617 ROFL` in `3499` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1451` | `41.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.88853555 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3498. Verify it yourself: <code>python3 verify.py</code></sub>
