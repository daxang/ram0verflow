...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3073"><img src="assets/ledger-light.svg?v=3073" width="100%" alt="ROFL ledger, height 3073"></picture>

| | |
|---|---|
| **height** | `3073` |
| **tip** | `f1693a54773a7c1dc12e80b7fa46d1d4e4ba07f014a116129edb4164d6b933bb` |
| **difficulty** | `57.3`  (bits `0x1d477f92`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,512,731,657,672` expected hashes |
| **supply** | `20999.12719320 ROFL` in `3074` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1262` | `41.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.60472376 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3073. Verify it yourself: <code>python3 verify.py</code></sub>
