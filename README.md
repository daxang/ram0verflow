...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3201"><img src="assets/ledger-light.svg?v=3201" width="100%" alt="ROFL ledger, height 3201"></picture>

| | |
|---|---|
| **height** | `3201` |
| **tip** | `3d2646d852a448a927d2a84345474bf6c268dcb28cab6b813da42660b57fb767` |
| **difficulty** | `30.9`  (bits `0x1e00848a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,518,431,223,504` expected hashes |
| **supply** | `20999.43847144 ROFL` in `3202` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1322` | `41.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.74663000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3201. Verify it yourself: <code>python3 verify.py</code></sub>
