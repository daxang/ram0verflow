...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3121"><img src="assets/ledger-light.svg?v=3121" width="100%" alt="ROFL ledger, height 3121"></picture>

| | |
|---|---|
| **height** | `3121` |
| **tip** | `78abe8e314b39a6ef518fd5a3c3cb4531f2a1302b5714f38a7c1a09964b26758` |
| **difficulty** | `41.2`  (bits `0x1d63822a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,515,278,622,022` expected hashes |
| **supply** | `20999.27367720 ROFL` in `3122` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1287` | `41.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.68101751 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3121. Verify it yourself: <code>python3 verify.py</code></sub>
