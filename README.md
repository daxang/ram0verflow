...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3493"><img src="assets/ledger-light.svg?v=3493" width="100%" alt="ROFL ledger, height 3493"></picture>

| | |
|---|---|
| **height** | `3493` |
| **tip** | `3b0934f4704091fc9028bc1a0c61b755eda0e2d6a5673b38358cfc3f76f4ff53` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,549,981,374` expected hashes |
| **supply** | `20999.78179152 ROFL` in `3494` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3493` | `3b0934f4704091fc9028…` | [@hbzhong](https://github.com/hbzhong) | `账户有波动，晚饭要稳定。` | `1` | `0.00076293` | 2026-09-23 20:34 UTC |
...
| [@hbzhong](https://github.com/hbzhong) | `296` | `8.5%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.45132277 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3493. Verify it yourself: <code>python3 verify.py</code></sub>
