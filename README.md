...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3042"><img src="assets/ledger-light.svg?v=3042" width="100%" alt="ROFL ledger, height 3042"></picture>

| | |
|---|---|
| **height** | `3042` |
| **tip** | `8358eb0b82ffe0a6e44d36d46952f70abd5737320021625a29918c44d18f3b16` |
| **difficulty** | `93.6`  (bits `0x1d2bc43a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,510,097,417,444` expected hashes |
| **supply** | `20999.03258895 ROFL` in `3043` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1234` | `40.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.51927476 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3042. Verify it yourself: <code>python3 verify.py</code></sub>
