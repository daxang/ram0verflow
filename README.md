...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3049"><img src="assets/ledger-light.svg?v=3049" width="100%" alt="ROFL ledger, height 3049"></picture>

| | |
|---|---|
| **height** | `3049` |
| **tip** | `6a1c5d5ba083c351a8f1c5f6655451411219765f990baae3ff15e031061957e1` |
| **difficulty** | `93.6`  (bits `0x1d2bc43a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,510,784,352,980` expected hashes |
| **supply** | `20999.05395120 ROFL` in `3050` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1241` | `40.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.54063701 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3049. Verify it yourself: <code>python3 verify.py</code></sub>
