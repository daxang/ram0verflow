...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3275"><img src="assets/ledger-light.svg?v=3275" width="100%" alt="ROFL ledger, height 3275"></picture>

| | |
|---|---|
| **height** | `3275` |
| **tip** | `512b6dfe6b6da26af6e98717d27a701a061cfa4b84ef422e0393949aba445b27` |
| **difficulty** | `15.4`  (bits `0x1e010972`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,187,192,476` expected hashes |
| **supply** | `20999.55138582 ROFL` in `3276` unspent outputs |
...
| [@ram0verflow](https://github.com/ram0verflow) | `70` | `2.1%` |
...
| _unclaimed_ | `rofl1qhkhmy848s09y2jyly8jexk4gd3gnrrclxj2exx` | `2062.52288812 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3275. Verify it yourself: <code>python3 verify.py</code></sub>
