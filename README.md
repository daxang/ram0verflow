...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3343"><img src="assets/ledger-light.svg?v=3343" width="100%" alt="ROFL ledger, height 3343"></picture>

| | |
|---|---|
| **height** | `3343` |
| **tip** | `78ddb977752578b3b8cff1d26c5ac1fdd0f9f65831e4f48ac0d550924b47dc39` |
| **difficulty** | `1.0`  (bits `0x1e0fa4da`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,392,695,124` expected hashes |
| **supply** | `20999.65514498 ROFL` in `3344` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3343` | `78ddb977752578b3b8cf…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00152587` | 2026-09-22 13:18 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1368` | `40.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.81682002 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3343. Verify it yourself: <code>python3 verify.py</code></sub>
