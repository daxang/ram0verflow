...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3344"><img src="assets/ledger-light.svg?v=3344" width="100%" alt="ROFL ledger, height 3344"></picture>

| | |
|---|---|
| **height** | `3344` |
| **tip** | `fb3c85c850bfefa097f3b7046d36c7b032478e03c719427317de9dda2b1e0164` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,393,743,699` expected hashes |
| **supply** | `20999.65667085 ROFL` in `3345` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1369` | `40.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.81834589 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3344. Verify it yourself: <code>python3 verify.py</code></sub>
