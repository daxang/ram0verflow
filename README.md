...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3378"><img src="assets/ledger-light.svg?v=3378" width="100%" alt="ROFL ledger, height 3378"></picture>

| | |
|---|---|
| **height** | `3378` |
| **tip** | `6f84dd89b625323661cfc285ee736da7fa86f2a74fd9fc055a660ff8a27bfbc7` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,429,395,249` expected hashes |
| **supply** | `20999.69405457 ROFL` in `3379` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.42233143 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3378. Verify it yourself: <code>python3 verify.py</code></sub>
