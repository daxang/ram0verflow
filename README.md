...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3079"><img src="assets/ledger-light.svg?v=3079" width="100%" alt="ROFL ledger, height 3079"></picture>

| | |
|---|---|
| **height** | `3079` |
| **tip** | `3babcf549643e88375b8a1daea84bcf8683018f27e6b0e6684de8869bcf03f55` |
| **difficulty** | `57.3`  (bits `0x1d477f92`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,513,092,082,964` expected hashes |
| **supply** | `20999.14550370 ROFL` in `3080` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1268` | `41.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.62303426 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3079. Verify it yourself: <code>python3 verify.py</code></sub>
