...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3290"><img src="assets/ledger-light.svg?v=3290" width="100%" alt="ROFL ledger, height 3290"></picture>

| | |
|---|---|
| **height** | `3290` |
| **tip** | `125e94c131bdf15f787d97306796b4ef4e1ba964dfc56886b9f818c2da5027f7` |
| **difficulty** | `4.7`  (bits `0x1e036f09`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,305,659,423` expected hashes |
| **supply** | `20999.57427387 ROFL` in `3291` unspent outputs |
...
| `3281` | `2fc4283e3820e3529680…` | [@ywltby](https://github.com/ywltby) | `不要小瞧EDG所有人的羁绊啊。` | `1` | `0.00152587` | 2026-09-21 19:45 UTC |
...
| [@b81913221-ai](https://github.com/b81913221-ai) | `46` | `1.4%` |
...
| _unclaimed_ | `rofl1qyj5rcsu0wazjesvrve9utmvty4t8p0n9ulsd2f` | `0.22125214 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3290. Verify it yourself: <code>python3 verify.py</code></sub>
