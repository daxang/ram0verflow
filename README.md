...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3438"><img src="assets/ledger-light.svg?v=3438" width="100%" alt="ROFL ledger, height 3438"></picture>

| | |
|---|---|
| **height** | `3438` |
| **tip** | `91619d3504dfb3b3a10b4cac72e2c337f097a499bc2ce8af4fa258e7c91b603d` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,492,309,749` expected hashes |
| **supply** | `20999.73983037 ROFL` in `3439` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `275` | `8.0%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.43530124 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3438. Verify it yourself: <code>python3 verify.py</code></sub>
