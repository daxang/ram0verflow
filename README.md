...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3484"><img src="assets/ledger-light.svg?v=3484" width="100%" alt="ROFL ledger, height 3484"></picture>

| | |
|---|---|
| **height** | `3484` |
| **tip** | `c39c407f6945031198e46c9c1e7f100cef454ac22bf1b0189a7de1d07c92bcea` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,540,544,199` expected hashes |
| **supply** | `20999.77492515 ROFL` in `3485` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3484. Verify it yourself: <code>python3 verify.py</code></sub>
