...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3021"><img src="assets/ledger-light.svg?v=3021" width="100%" alt="ROFL ledger, height 3021"></picture>

| | |
|---|---|
| **height** | `3021` |
| **tip** | `cee4b6628ec7c39a09cd3a95ccdb1bb28fb79dc7992d70ee8dc041d376fbf64c` |
| **difficulty** | `141.4`  (bits `0x1d1cf838`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,507,526,982,116` expected hashes |
| **supply** | `20998.96850220 ROFL` in `3022` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1214` | `40.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.45823976 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3021. Verify it yourself: <code>python3 verify.py</code></sub>
