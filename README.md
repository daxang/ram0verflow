...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3419"><img src="assets/ledger-light.svg?v=3419" width="100%" alt="ROFL ledger, height 3419"></picture>

| | |
|---|---|
| **height** | `3419` |
| **tip** | `fb26d3a3e8c3eb0a6368697abf92f88cc903a6606f21860488ac7d9065413164` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,472,386,824` expected hashes |
| **supply** | `20999.72533470 ROFL` in `3420` unspent outputs |
...
| [@b81913221-ai](https://github.com/b81913221-ai) | `68` | `2.0%` |
...
| _unclaimed_ | `rofl1qyj5rcsu0wazjesvrve9utmvty4t8p0n9ulsd2f` | `0.24871776 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3419. Verify it yourself: <code>python3 verify.py</code></sub>
