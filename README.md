...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3150"><img src="assets/ledger-light.svg?v=3150" width="100%" alt="ROFL ledger, height 3150"></picture>

| | |
|---|---|
| **height** | `3150` |
| **tip** | `28dd60b038a5a8183bdbed358bd0083714dacb03a968dc1d13b25d40fc3cb78a` |
| **difficulty** | `41.8`  (bits `0x1d6216a0`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,516,539,688,304` expected hashes |
| **supply** | `20999.36065207 ROFL` in `3151` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1296` | `41.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.70695738 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3150. Verify it yourself: <code>python3 verify.py</code></sub>
