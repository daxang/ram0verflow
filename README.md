...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3200"><img src="assets/ledger-light.svg?v=3200" width="100%" alt="ROFL ledger, height 3200"></picture>

| | |
|---|---|
| **height** | `3200` |
| **tip** | `13a3e7d678a9825624c805f8e283dacde48c2dd928d5255b0f0342ebf8df182b` |
| **difficulty** | `30.9`  (bits `0x1e00848a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,518,398,818,210` expected hashes |
| **supply** | `20999.43694557 ROFL` in `3201` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3200. Verify it yourself: <code>python3 verify.py</code></sub>
