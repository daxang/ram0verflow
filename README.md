...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3137"><img src="assets/ledger-light.svg?v=3137" width="100%" alt="ROFL ledger, height 3137"></picture>

| | |
|---|---|
| **height** | `3137` |
| **tip** | `706487c871edb904e9c67303073d26b4c8485a873e64726efd73518d60f32f18` |
| **difficulty** | `41.8`  (bits `0x1d6216a0`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,515,970,461,100` expected hashes |
| **supply** | `20999.32250520 ROFL` in `3138` unspent outputs |
...
| `3129` | `35ce38940b56b657cc6f…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.00305175` | 2026-09-20 09:00 UTC |
| `3128` | `8cd8f2946ab77ecb70cc…` | [@hbzhong](https://github.com/hbzhong) | `认错不收手续费，嘴硬可能收。` | `1` | `0.00305175` | 2026-09-20 09:00 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1290` | `41.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.69017276 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3137. Verify it yourself: <code>python3 verify.py</code></sub>
