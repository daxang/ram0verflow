...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3286"><img src="assets/ledger-light.svg?v=3286" width="100%" alt="ROFL ledger, height 3286"></picture>

| | |
|---|---|
| **height** | `3286` |
| **tip** | `46d4515c03c3691111a0054a337d15c9b27ad0e4482f3e6dc6fa4afe103e403b` |
| **difficulty** | `4.7`  (bits `0x1e036f09`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,286,115,419` expected hashes |
| **supply** | `20999.56817039 ROFL` in `3287` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3286. Verify it yourself: <code>python3 verify.py</code></sub>
