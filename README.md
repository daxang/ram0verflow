...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3376"><img src="assets/ledger-light.svg?v=3376" width="100%" alt="ROFL ledger, height 3376"></picture>

| | |
|---|---|
| **height** | `3376` |
| **tip** | `d46f130570c446e3a656b86e3ead3d5ae49f8a1d1dcd4451db184eedeb421c43` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,427,298,099` expected hashes |
| **supply** | `20999.69252871 ROFL` in `3377` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3376. Verify it yourself: <code>python3 verify.py</code></sub>
