...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3304"><img src="assets/ledger-light.svg?v=3304" width="100%" alt="ROFL ledger, height 3304"></picture>

| | |
|---|---|
| **height** | `3304` |
| **tip** | `1178ef6c25c21a3125540b84074971ba0b0c992f0b8f39e44eec9b53975d5747` |
| **difficulty** | `1.5`  (bits `0x1e0ad91c`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,344,008,468` expected hashes |
| **supply** | `20999.59563605 ROFL` in `3305` unspent outputs |
...
| [@b81913221-ai](https://github.com/b81913221-ai) | `56` | `1.7%` |
...
| _unclaimed_ | `rofl1qyj5rcsu0wazjesvrve9utmvty4t8p0n9ulsd2f` | `0.23651084 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3304. Verify it yourself: <code>python3 verify.py</code></sub>
