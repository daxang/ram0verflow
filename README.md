...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3022"><img src="assets/ledger-light.svg?v=3022" width="100%" alt="ROFL ledger, height 3022"></picture>

| | |
|---|---|
| **height** | `3022` |
| **tip** | `a5ff1fb08c6bc0af1e3175432534d3c85a3501014ecdfe2097f8a1dc6e5a5642` |
| **difficulty** | `141.4`  (bits `0x1d1cf838`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,507,675,239,828` expected hashes |
| **supply** | `20998.97155395 ROFL` in `3023` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3022` | `a5ff1fb08c6bc0af1e31…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.00305175` | 2026-09-19 12:14 UTC |
| `3021` | `cee4b6628ec7c39a09cd…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00305175` | 2026-09-19 12:04 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1215` | `40.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.46129151 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3022. Verify it yourself: <code>python3 verify.py</code></sub>
