...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3517"><img src="assets/ledger-light.svg?v=3517" width="100%" alt="ROFL ledger, height 3517"></picture>

| | |
|---|---|
| **height** | `3517` |
| **tip** | `923bb0e62fa9ba1af9707b15074b4b056c72870462b056d47da5edf9b0bd8992` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,575,147,174` expected hashes |
| **supply** | `20999.80010184 ROFL` in `3518` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3517` | `923bb0e62fa9ba1af970…` | [@hbzhong](https://github.com/hbzhong) | `没拿到主链签字，先不算浮盈。` | `1` | `0.00076293` | 2026-09-24 01:39 UTC |
...
| [@hbzhong](https://github.com/hbzhong) | `305` | `8.7%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.45818914 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3517. Verify it yourself: <code>python3 verify.py</code></sub>
