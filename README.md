...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3118"><img src="assets/ledger-light.svg?v=3118" width="100%" alt="ROFL ledger, height 3118"></picture>

| | |
|---|---|
| **height** | `3118` |
| **tip** | `6f1cda2bf3c5e84fb2175179aab12b13ef06e5d42d3fa26654c481964dfdfc9a` |
| **difficulty** | `48.8`  (bits `0x1d53f385`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,515,141,138,101` expected hashes |
| **supply** | `20999.26452195 ROFL` in `3119` unspent outputs |
...
| `3109` | `13a3cf91cde1978ba6cb…` | [@b81913221-ai](https://github.com/b81913221-ai) | `gm` | `1` | `0.00305175` | 2026-09-20 05:38 UTC |
...
| _unclaimed_ | `rofl1q2fuw29475jc0mf2tfmufkf90u76pxwtlxn997z` | `0.01220700 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3118. Verify it yourself: <code>python3 verify.py</code></sub>
