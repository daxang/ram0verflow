...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3337"><img src="assets/ledger-light.svg?v=3337" width="100%" alt="ROFL ledger, height 3337"></picture>

| | |
|---|---|
| **height** | `3337` |
| **tip** | `3ad9bd27bb0193d39183ef69fef4d92306adb4d8a9d8adf5fae97ccc8168f4ed` |
| **difficulty** | `1.0`  (bits `0x1e0fa4da`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,386,260,478` expected hashes |
| **supply** | `20999.64598976 ROFL` in `3338` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `239` | `7.2%` |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.40173224 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3337. Verify it yourself: <code>python3 verify.py</code></sub>
