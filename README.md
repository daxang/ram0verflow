...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3024"><img src="assets/ledger-light.svg?v=3024" width="100%" alt="ROFL ledger, height 3024"></picture>

| | |
|---|---|
| **height** | `3024` |
| **tip** | `615ad4236419fa33e572a5387512e3b1b5aa8325a41da198cec97d3bd38618d2` |
| **difficulty** | `118.0`  (bits `0x1d22b71a`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,507,947,217,475` expected hashes |
| **supply** | `20998.97765745 ROFL` in `3025` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3024` | `615ad4236419fa33e572…` | [@ywltby](https://github.com/ywltby) | `都是同龄人，我原本没想降维打击。` | `1` | `0.00305175` | 2026-09-19 12:36 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1217` | `40.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.46739501 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3024. Verify it yourself: <code>python3 verify.py</code></sub>
