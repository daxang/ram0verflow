...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3149"><img src="assets/ledger-light.svg?v=3149" width="100%" alt="ROFL ledger, height 3149"></picture>

| | |
|---|---|
| **height** | `3149` |
| **tip** | `fef2c1b553fc95f6620e54303922d5233614a3e28fadb99ddcf6fab6c4ebaae2` |
| **difficulty** | `41.8`  (bits `0x1d6216a0`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,516,495,901,596` expected hashes |
| **supply** | `20999.35912620 ROFL` in `3150` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1295` | `41.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.70543151 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3149. Verify it yourself: <code>python3 verify.py</code></sub>
