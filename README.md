...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3387"><img src="assets/ledger-light.svg?v=3387" width="100%" alt="ROFL ledger, height 3387"></picture>

| | |
|---|---|
| **height** | `3387` |
| **tip** | `b7d39ae34d2d190a2f00868d1029ceed931b83d03ad0d87e25b8dcea059af369` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,438,832,424` expected hashes |
| **supply** | `20999.70092094 ROFL` in `3388` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1393` | `41.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.84428561 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3387. Verify it yourself: <code>python3 verify.py</code></sub>
