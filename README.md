...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3171"><img src="assets/ledger-light.svg?v=3171" width="100%" alt="ROFL ledger, height 3171"></picture>

| | |
|---|---|
| **height** | `3171` |
| **tip** | `1c2a10c2a43f093dc3cce788487b1eafab79c63d65de47883bdfaf2056cb41e2` |
| **difficulty** | `35.0`  (bits `0x1d75156b`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,517,424,430,224` expected hashes |
| **supply** | `20999.39269534 ROFL` in `3172` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1309` | `41.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.72679369 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3171. Verify it yourself: <code>python3 verify.py</code></sub>
