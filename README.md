...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3185"><img src="assets/ledger-light.svg?v=3185" width="100%" alt="ROFL ledger, height 3185"></picture>

| | |
|---|---|
| **height** | `3185` |
| **tip** | `2224d7af0739729b4bcdcf0634c2375f659fc748ad9bcea82ec2fe0058007802` |
| **difficulty** | `29.9`  (bits `0x1e0088f3`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,517,927,348,416` expected hashes |
| **supply** | `20999.41405752 ROFL` in `3186` unspent outputs |
...
| [@hbzhong](https://github.com/hbzhong) | `rofl1q722t3c2emfk7utwz4y09xwxs0670kknthwuler` | `2.32543874 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3185. Verify it yourself: <code>python3 verify.py</code></sub>
