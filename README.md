...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3449"><img src="assets/ledger-light.svg?v=3449" width="100%" alt="ROFL ledger, height 3449"></picture>

| | |
|---|---|
| **height** | `3449` |
| **tip** | `d852bef6399eaa6685f32f6bdf1c35dec2fcf21118fcdb42a2593a5712e9fac9` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,503,844,074` expected hashes |
| **supply** | `20999.74822260 ROFL` in `3450` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3449` | `d852bef6399eaa6685f3…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.00076293` | 2026-09-23 11:17 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1424` | `41.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.86793644 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3449. Verify it yourself: <code>python3 verify.py</code></sub>
